...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<rbnacl-libsodium>, ["~> 1.0.10"])
      s.add_development_dependency(%q<rbnacl>, ["~> 3.4.0"])
      ...
      s.add_dependency(%q<rbnacl-libsodium>, ["~> 1.0.10"])
      s.add_dependency(%q<rbnacl>, ["~> 3.4.0"])
